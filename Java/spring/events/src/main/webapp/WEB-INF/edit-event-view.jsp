...
<body style="text-align:center">
	...
	<form:form action="/events/${ event.id }/edit" method="POST" modelAttribute="event">
		...
		<form:input path="name" type="text" class="form-control" placeholder="Event Name" value="${ event.name }" />
		<form:input path="city" type="text" class="form-control" placeholder="City" value="${ event.city }" />
